...
class IndustryResearcherAgent:
    def __init__(self):
        ...
        # 2026년 시장 주도/성장 사이클 업종 키워드 및 가점
        # (시장 흐름 변화에 따라 주기적으로 수동 업데이트 필요)
        self.growth_sectors = {
            "반도체": 25,        # HBM, AI 가속기 핵심 — 최상위 주도
            "소프트웨어": 20,    # AI 에이전트, SaaS
            "컴퓨터": 20,        # AI 서버, 데이터센터 인프라
            "전기제품": 20,      # 전력설비(변압기), 이차전지
            "방산": 20,          # 수출 확대 지속
            "조선": 18,          # 수주 잔고 호조
            "우주항공": 18,      # 위성, 발사체 수혜
            "바이오": 15,        # 신약 승인 모멘텀
